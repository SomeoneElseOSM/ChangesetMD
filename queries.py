...
CREATE TABLE osm_changeset_comment (
  ...
  comment_commenter_id bigint not null,
  comment_commenter_name varchar(255) not null,
  comment_commented_id bigint not null,
  comment_commented_name varchar(255) not null,
